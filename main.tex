...
\usepackage{listings}
\lstset{
  numbers=left, numberstyle=\tiny\sf\color{gray},
  basicstyle=\small\ttfamily, basewidth=.5em,
  moredelim=[s][\color{darkgray}]{"}{"},
  comment=[l]{\%}, commentstyle=\itshape\color{gray},
  classoffset=0,
  keywords={Define,by,Kind,Type}, keywordstyle=\color{teal},
  classoffset=1,
  morekeywords={inductive,coinductive}, keywordstyle=\color{blue},
  classoffset=2,
  morekeywords={forall,exists,nabla,prop,type,_if,_not}, keywordstyle=\color{brown},
  classoffset=0,
  alsoletter={\\},
  literate=%
    {:}{{{\color{teal}:}}}1
...
\begin{figure}
\begin{itemize}
\item[]\hspace{-2ex}{\it\texttt{case\;1}}\quad
$\exists P_1\;\pi,~ P\xrightarrow{\pi}P_1 ~\text{but}~
 \text{not}\,(\exists Q_1,~ Q\xrightarrow{\pi}Q_1)$
    ...
    \\
\item[]\hspace{-2ex}{\it\texttt{case\;2}}\quad
...
$\displaystyle\begin{array}{ll}
  ...
  &\quad\forall Q_1,~ (P,Q)\xrightarrow{\pi}(P_1,Q_1) ~\text{and}~ \\
  &\qquad\qquad\qquad\quad~\texttt{d}(P_1,Q_1)\in V \end{array} $
    \qquad
    \fbox{ $\displaystyle
...
$\displaystyle\begin{array}{ll}
  ...
  &\quad\forall P_1,~ (P,Q)\xrightarrow{\pi}(P_1,Q_1) ~\text{and}~ \\
  &\qquad\qquad\qquad\quad~\texttt{d}(P_1,Q_1)\in V \end{array} $
    \qquad
    \fbox{ $\displaystyle
