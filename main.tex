...
%% \begin{abstract}
\vspace*{-3ex}
\keywords{bisimulation, modal logic, distinguishing formula, process calculus %, process algebra
}
%% \end{abstract}
...
of the tool. Second, users are provided with useful information to analyze why
the processes are not equivalent when the test fails, which occurs very frequently
in practice. A typical usage scenario would involve
