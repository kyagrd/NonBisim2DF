...
To see the rendered html files you need to download the two html files in a same directory (either by checking out this repository as a whole or download the two raw content separtely) and load it with your web browser.
